...
FindInputDeviceInList(HID_DEVICE_INFO_LIST hidInfoList, TCHAR* deviceName, const unsigned int cbDeviceName, PHIDP_PREPARSED_DATA preparsedData, const UINT cbPreparsedData) {
...
FindLinkCollectionInList(HID_LINK_COL_INFO_LIST linkColInfoList, USHORT linkCollection) {
